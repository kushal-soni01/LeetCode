<!-- leetlens:questionId=1096 -->
<!-- leetlens:approach=Recursive parsing with hash sets -->
<!-- leetlens:difficulty=Hard -->
<!-- leetlens:language=java -->
<!-- leetlens:pushedAt=1790367004435 -->
...
| Field | Value |
|---|---|
| Approach | Recursive parsing with hash sets |
