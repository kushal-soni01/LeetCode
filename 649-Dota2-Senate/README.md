<!-- leetlens:questionId=649 -->
<!-- leetlens:approach=Queue-based simulation -->
<!-- leetlens:difficulty=Medium -->
<!-- leetlens:language=java -->
<!-- leetlens:pushedAt=1785593453678 -->
...
- n == senate.length 1 <= n <= 10 4 senate[i] is either 'R' or 'D' .
...
| Field | Value |
|---|---|
| Approach | Queue-based simulation |
| Time Complexity | O(n) |
